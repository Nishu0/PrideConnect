    ...
    <section aria-label="Site Footer" className=" bg-gray-900 text-white">
        <div className="max-w-screen-xl px-4 py-16 mx-auto space-y-8 sm:px-6 lg:space-y-16 lg:px-8">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              <div className="text-teal-600">
                <img src='/assets/images/logo.svg' className='w-40' alt='typefinance logo'/>
              </div>
              <p className="max-w-xs mt-4 text-gray-500">
              Embrace Pride, Connect with Love and Equality.
              </p>
              <ul className="flex gap-6 mt-8">
                ...
                <li>
                  <Link href="https://github.com/Nishu0" rel="noreferrer" target="_blank" className="transition hover:opacity-75">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
              <div>
                ...
                <nav aria-label="Footer Navigation - Jobs" className="mt-6">
                  <ul className="space-y-4 text-sm">
                    <li>
                      <Link href="/jobs" className="text-gray-300 transition hover:opacity-75">
                        Asseteer Tool
                      </Link>
                    </li>
                  </ul>
              ...
              <div>
                ...
                <nav aria-label="Footer Navigation - Company" className="mt-6">
                  <ul className="space-y-4 text-sm">
                    <li>
                      <Link href="/feed" className="text-gray-300 transition hover:opacity-75">
                        Comunity Feed
                      </Link>
                    </li>
                  </ul>
              ...
              <div>
                <p className="font-medium ">Helpful Info</p>
                <nav aria-label="Footer Navigation - Company" className="mt-6">
                  <ul className="space-y-4 text-sm">
                    <li>
                      <Link href="/information" className="text-gray-300 transition hover:opacity-75">
                        LGBTQ Info
                      </Link>
                    </li>
                    <li>
          ...
          <p className="text-xs text-gray-500">
            Created with ❤️ by <Link href="https://nisargthakkar.vercel.app/" className="text-gray-500 transition hover:opacity-75">Nisarg Thakkar</Link>
          </p>
        </div>
      </section>
    </footer>
